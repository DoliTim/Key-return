...
const LandingPage = () => {
  return (
    <div>
      ...
      {/* 3D Model Section */}
      <div className="hero-3d-model" style={{ position: 'absolute', right: '23%', top: '20%', width: '45%', height: '73%', transform: 'translateX(50%)', zIndex: 1 }}> {/* Center container on the right side of the screen */}
        <Canvas>
